    ...
    return (
        <div className="min-h-screen bg-space-950 text-slate-300 font-sans selection:bg-champagne-400/30 selection:text-white relative scroll-smooth">
            ...
            <div className="relative z-10 container mx-auto px-6 py-12 max-w-6xl">
                ...
                {/* Navigation / Header */}
                <nav className="flex justify-between items-center mb-12 animate-float" style={{ animationDuration: '8s' }}>
                ...
                <header className="flex flex-col items-center justify-center text-center mb-32 relative">
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-thin tracking-tighter mb-6 drop-shadow-[0_0_15px_rgba(255,255,255,0.1)] px-4 flex flex-col items-center gap-2">
                        <span className="text-transparent bg-clip-text bg-gradient-to-b from-white via-slate-200 to-slate-600">ARTIFICIAL INTELLIGENCE ENGINEER</span>
                        <span className="font-light text-champagne-200/90 whitespace-nowrap">Abhishek Chaudhari</span>
                    </h1>
                ...
                <section id="about" className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-32 scroll-mt-24">
                    <GlassCard className="col-span-1 md:col-span-2 flex flex-col justify-center">
                        <div className="flex flex-col md:flex-row gap-8 items-start">
                            ...
                            <div className="w-32 h-32 shrink-0 rounded-2xl bg-white/5 border border-white/10 overflow-hidden relative group">
                                ...
                                {/* <img src="/path/to/your/image.jpg" alt="Profile" className="w-full h-full object-cover opacity-80 hover:opacity-100 transition-opacity" /> */}
                            </div>
                ...
                <footer className="border-t border-white/10 pt-12 flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-4">
                        <a href="https://github.com/AbhishekC1005" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-white/40 hover:bg-white/5 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all">
                            <Github className="w-4 h-4" />
                        </a>
                        <a href="https://www.linkedin.com/in/abhishek-chaudhari-792b3929b/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full border border-white/10 flex items-center justify-center text-slate-400 hover:text-white hover:border-white/40 hover:bg-white/5 hover:shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-all">
